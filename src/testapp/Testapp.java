     ...
     //   guideserv.UpdateGuide(g3 );
      //  System.out.println( guideserv.getguideid(g3 ) ) ;  
        ...
        */
        ...
        ServicesHotel hotelserv = new ServicesHotel();
        Hotel h1 = new Hotel("Africa22ssss jad","Korba","centre ville","Africa@gmail.tn",350,"aa");
        /*  for (Hotel h : hotelserv.ViewHotel()) {
            System.out.println(h);
        }
        hotelserv.CreateHotel(h1);
        */
        h1.setId(18);
        //hotelserv.UpdateHotel(h1);
        //hotelserv.CreateHotel(h1);
        //hotelserv.DeleteHotel(h1);
